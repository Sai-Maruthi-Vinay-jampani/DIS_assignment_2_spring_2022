...
*/
/*******************************************
 * self reflection : Due to this assignment i have learned about dictioneries alot and i have also learned how impirtant
 * to know the time complexity
 * time take : i have taken one and half day to complete all the problems, most of the time was spent on question5
 * recommendation: i would like to take another assignment.
 * *******************************************
 */
using System;
        ...
        */
        ...
        public static int SearchInsert(int[] nums, int target)
        {
            try
            {
                ...
                // checking for the index using the binary search
                    int min = 0;
                ...
                // if the value is found or not found the index will be the same as the while loop breaks at the same position in both the cases.
                return max+1;
            }
            catch (Exception)
            {
        ...
        */
        ...
        public static int FindLucky(int[] arr)
        {
            try
            {
                ...
                int[] temp = arr.Distinct().ToArray();
                int tout = -1;
                // checking the value  and index are equal
                for (int i = 0; i < temp.Length; i++)
                {
                    if (ind[temp[i]] == temp[i])
                    {
                        if (temp[i] > tout)
                        {
                            tout = temp[i];
        ...
        */
        ...
        public static string GetHint(string secret, string guess)
        {
            try
            {
                ...
                string temp2 = bull_count + "A" + cow_count + "B";
                return temp2;
            }
            catch (Exception)
            {
        ...
        public static List<int> PartitionLabels(string s)
        {
            try
            {
                ...
                for (int i = 0; i < s.Length; i++)
                {
                    ...
                    if (endindex == i)
                    {
                        lengths.Add(endindex - startindex + 1);
                        startindex = i + 1;
                        endindex = i + 1;
                    }
                }
        ...
        public static int UniqueMorseRepresentations(string[] words)
        {
            try
            {
                ...
                for (int i=0;i<n;i++ )
                {
                    ...
                    for (int j=0;j<l1;j++)
                    {
                        output[i] += myDict[words[i][j]];
                    }
                }
                string[] nout = output.Distinct().ToArray();
                int num = nout.Length;
                return num;
            }
            catch (Exception)
